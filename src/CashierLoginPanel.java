...
public class CashierLoginPanel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CashierLoginPanel frame = new CashierLoginPanel();
	...
	public CashierLoginPanel() {
		...
		JLabel lblAdminLogin = new JLabel("CASHIER LOGIN");
		lblAdminLogin.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdminLogin.setFont(new Font("Tahoma", Font.BOLD, 28));
		lblAdminLogin.setBounds(164, 11, 254, 38);
		...
		btnGoBack.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				...
				btnGoBack.setForeground(new Color(102, 0, 153));
			}
		});
